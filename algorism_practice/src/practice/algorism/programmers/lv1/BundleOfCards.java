...
public class BundleOfCards {
    ...
    public static void main(String[] args) {
        BundleOfCards boc = new BundleOfCards();
        System.out.println(boc.solution(new String[] {"i", "drink", "water"}, new String[] {"want", "to"}, new String[] {"i", "want", "to", "drink", "water"}));
        System.out.println(boc.solution(new String[] {"i", "water", "drink"}, new String[] {"want", "to"}, new String[] {"i", "want", "to", "drink", "water"}));
    }
