...
public class ThreeMusketeers {
    public static void main(String[] args) {
        ...
        System.out.println(tm.solution(new int[] {-2, 3, 0, 2, -5}));
        System.out.println(tm.solution(new int[] {-3, -2, -1, 0, 1, 2, 3}));
        System.out.println(tm.solution(new int[] {-1, 1, -1, 1}));
    }
    ...
    public int solution(int[] number) {
        ...
        for(int f = 0; f < number.length; f++) {
            ...
            for(int s = f + 1; s < number.length; s++) {

                for(int t = s + 1; t < number.length; t++) {

                    System.out.println(number[f] + " + " + number[s] + " + " + number[t] + " = " + (number[f] + number[s] + number[t]));
                    if(number[f] + number[s] + number[t] == 0) answer++;
