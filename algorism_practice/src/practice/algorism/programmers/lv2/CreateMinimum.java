...
public class CreateMinimum {
    public static void main(String[] args) {
        CreateMinimum cm = new CreateMinimum();
        System.out.println("RESULT : " + cm.solution(new int[] {1, 4, 2}, new int[] {5, 4, 4}));
        System.out.println("RESULT : " + cm.solution(new int[] {1, 2}, new int[] {3, 4}));
        System.out.println("RESULT : " + cm.solution(new int[] {1, 2}, new int[] {2, 10}));
    }
