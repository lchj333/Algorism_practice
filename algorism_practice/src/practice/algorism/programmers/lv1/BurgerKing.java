...
public class BurgerKing {
    public int solution(int[] ingredient) {
        ...
        for(int temp : ingredient) {
            ...
            }else { // not burgerStack.isEmpty()
                if(temp == 1) { //빵차례
                    if(burgerStack.peek() == 3) {//햄벅 완성
                        burgerStack.pop();
                        answer++;
                    }else    // 그 위에 빵
                        burgerStack.add(1);
                }else if(temp == burgerStack.peek()+1) { //알맞은 재료
                    burgerStack.push(burgerStack.pop()+1);
                }else   //부적합 재료
                    burgerStack = new Stack<>();
            }

            System.out.println("burgerStack => " + burgerStack);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("answer : " + new BurgerKing().solution(ingredient));
    }
}
/*
